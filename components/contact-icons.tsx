...
export function FacebookIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path
        d="M13.5 21v-6.5h2.1l.4-2.6h-2.5V10.2c0-.75.2-1.25 1.28-1.25h1.37V6.6c-.24-.03-1.05-.1-1.99-.1-1.97 0-3.32 1.2-3.32 3.4v1.9H8.4v2.6h2.5V21"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
...
/**
 * A diferencia del resto de los íconos de este archivo, este va relleno y no
 * de contorno: se usa sobre el verde del botón flotante, y a ese tamaño un
 * trazo de 1.6 se ve deslavado. Es el glifo de marca, que la gente reconoce
 * de un vistazo — por eso no se estiliza.
 */
